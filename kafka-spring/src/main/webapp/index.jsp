...
<div id="producer">
    ...
    <br>
    <button onclick="send('spring')">主题kafka-spring-topic</button>
    <button onclick="send('springb')">主题kafka-spring-topic-b</button>
    <br>
    <span id="status"></span>
</div>
</body>
